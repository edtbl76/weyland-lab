...
- For internal CI-tooling work in this solo $0 LAN homelab, pre-answer the intent-capture questions about market, external customers, and multi-stakeholder communication as Not Applicable (leaving the user free to correct) rather than interrogating each one — the answers are self-evident from context, and over-asking them is the ceremony the lean-AIDLC preference exists to avoid (learned 2026-09-17) (learned 2026-09-17) <!-- cid:intent-capture:c1 -->
