...
- **Code quality & security scanning (B43 → B69/B89/B90):** two weekly k8s CronJobs (ns `weyland`) scan the repo —
  **`code-scan-suite`** runs the **19-tool multi-language roster** declared in the repo-root **`quality-tools.yaml`**
