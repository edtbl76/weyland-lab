...
- **Code quality & security scanning (B43 → B69/B89/B90):** two weekly k8s CronJobs (ns `weyland`) scan the repo —
  **`code-scan-suite`** runs **9 OSS tools** in one image (gitleaks, checkov, kubescape, hadolint, bandit, osv-scanner,
