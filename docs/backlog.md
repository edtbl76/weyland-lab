...
### B134 — CPU request management: right-size reservations + move more systems on-demand — **MEDIUM — HELD FOR HARDWARE (↓ High→Medium 2026-09-19; reframed → resource right-sizing + state-aware on-demand)**
