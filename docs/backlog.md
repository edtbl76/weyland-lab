...
**Related:** [B126] (EMA-146, Low) is the *trial* follow-up — run OpenSpec or Spec Kit on one small unit. That is a separate, optional experiment; it does not discharge the four adoptions above.
