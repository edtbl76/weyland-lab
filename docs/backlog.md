...
**❌ Genuinely remaining:** 2 uncodified triggers (eval harness/leaderboard, ai_session producer crontab — docs-site rebuild ✅ codified 2026-07-20 as a daily 05:30 CronJob) · GitOps misc (n8n workflows→git, LiteLLM `main-stable`→digest, DataHub recipes UI→reconciled) · delete CT-102 + `hosts.md` cleanup · Prometheus/Loki retention caps · Wave 5 docs-drift.
