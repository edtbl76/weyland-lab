...
**❌ Genuinely remaining:** 2 uncodified triggers (docs-site rebuild, eval harness/leaderboard, ai_session producer crontab) · GitOps misc (n8n workflows→git, LiteLLM `main-stable`→digest, DataHub recipes UI→reconciled) · delete CT-102 + `hosts.md` cleanup · Prometheus/Loki retention caps · Wave 5 docs-drift.
