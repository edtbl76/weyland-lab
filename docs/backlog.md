...
### B70 — Agentic RAG on LangGraph + LlamaIndex + MLflow tracing — 🔧 IN PROGRESS (Parts 1+2 done 2026-07-22)
...
- **⏳ Part 3 — `weyland-agent`:** the LangGraph loop + 4 custom LlamaIndex retrievers + dual MLflow autolog, calling `weyland-guard` for outer I/O. **NEXT.**
