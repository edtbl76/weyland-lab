...
**Dagster ✅** (custom emitter) · **Grafana ✅** (UI pull connector 2026-06-26) · Iceberg/Nessie · Kafka · MLflow · Neo4j · Postgres · S3/MinIO · Qdrant · Weaviate · OpenSearch (playground) · lakeFS. _(CSV moved out → [B68], Maturity/Polish, blocked on finding Google Drive sheets.)_
...
**✅ Dagster (Tier 1) — DONE via custom emitter (2026-06-26).** 15 datasets + lineage in DataHub.
