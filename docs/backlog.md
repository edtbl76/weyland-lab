...
17. **U14** — n8n workflow → git — 🟡 **MEDIUM (2026-08-05).** audit active n8n workflows before working on this. See detail below.
...
24. **U16** — Weaviate UI — 🟡 **MEDIUM (2026-08-05).** evaluate whether still needed (native Weaviate UI may suffice). See detail below.
...
### B105 — Dagster job observability / progress logging — 🟡 MEDIUM (2026-08-05)
...
### B106 — Compare AI code-review tools: CodeRabbit vs Qodo vs DeepSource — 🟡 MEDIUM (2026-08-05; informs the B118 code-quality tooling)
...
### B108 — Generalize the demo-mode toggle across shadow systems — 🟡 MEDIUM (2026-08-05)
