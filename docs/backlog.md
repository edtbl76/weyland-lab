...
- **Object inspection + search** → **[B81]'s notebook library**, which already lists *"vector/graph (Qdrant/Weaviate/Lance similarity search)"* in its full-stack set. **This fold makes that notebook the explicit deliverable for U16's scope.**
