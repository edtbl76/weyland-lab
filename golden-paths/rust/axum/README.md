# Golden path — Rust / axum

Blessed paved-road axum service. **Runnable · ephemeral · extendable.** Conforms to the golden-path
...
(reads `.smoke`). Scaffold: `scripts/new-service.sh rust/axum <your-service>`.
