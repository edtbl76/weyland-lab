# Golden path — Rust / actix

Blessed paved-road actix service. **Runnable · ephemeral · extendable.** Conforms to the golden-path
...
(reads `.smoke`). Scaffold: `scripts/new-service.sh rust/actix <your-service>`.
