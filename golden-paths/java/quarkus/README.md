# Golden path — Java / quarkus

Blessed paved-road quarkus service. **Runnable · ephemeral · extendable.** Conforms to the golden-path
...
Scaffold: `scripts/new-service.sh java/quarkus <your-service>`.
