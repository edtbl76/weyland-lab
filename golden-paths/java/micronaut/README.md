# Golden path — Java / micronaut

Blessed paved-road micronaut service. **Runnable · ephemeral · extendable.** Conforms to the golden-path
...
Scaffold: `scripts/new-service.sh java/micronaut <your-service>`.
