...
Blessed paved-road echo service. **Runnable · ephemeral · extendable.** Conforms to the golden-path
...
(reads `.smoke`). Scaffold: `scripts/new-service.sh go/echo <your-service>`.
