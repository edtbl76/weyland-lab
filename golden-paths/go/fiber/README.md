# Golden path — Go / fiber

Blessed paved-road fiber service. **Runnable · ephemeral · extendable.** Conforms to the golden-path
...
(reads `.smoke`). Scaffold: `scripts/new-service.sh go/fiber <your-service>`.
