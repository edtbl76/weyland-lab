...
Blessed paved-road gin service. **Runnable · ephemeral · extendable.** Conforms to the golden-path
...
(reads `.smoke`). Scaffold: `scripts/new-service.sh go/gin <your-service>`.
