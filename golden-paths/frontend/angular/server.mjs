...
// Serves the ng build output (dist/golden-frontend-angular/browser/) with an SPA fallback AND the
// contract endpoints /health /ready /metrics /hello. Stdlib http only + prom-client; no framework runtime.
...
const SERVICE_NAME = 'golden-frontend-angular';
const DIST = fileURLToPath(new URL('./dist/golden-frontend-angular/browser/', import.meta.url));
