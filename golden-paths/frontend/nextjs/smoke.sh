#!/bin/sh
# Ephemeral smoke (Frontend/Next.js) — start the standalone server, poll /ready, assert /hello's
# payload and the SSR-rendered demo route both carry the greeting, exit.
set -u
